...
import { Center, GluestackUIProvider, NativeBaseProvider, extendTheme} from '@gluestack-ui/themed';
...
export const decorators = [
  (Story) => {
    ...
    return (
      <NativeBaseProvider config={config.theme} theme={extendTheme({colors: {
        // Add new color
        primary: {
          50: '#E3F2F9',
          100: '#C5E4F3',
